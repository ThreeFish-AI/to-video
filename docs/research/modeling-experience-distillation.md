...
| 决策点 | 候选 | 评选 | 理由 |
|---|---|---|---|
| 经验落点 | ① 追加进 skills/06 正文 ② 独立有界手册 ③ issue.md 台账复用 | **②** | ① 正是膨胀源；③ 混淆「机制缺陷」与「内容经验」的分流边界；② 与 [PRON-GLOSSARY](../../references/PRON-GLOSSARY.md) 同构（跨集沉淀台账先例），且不能放 `pipeline/skills/`（速查表恰 9 行执法） |
