#!/usr/bin/env python3
"""动效画面建模手册（pipeline/MODELING-PLAYBOOK.md）的体量与结构门。
...
用法（任意目录）：uv run --no-project $T/pipeline/scripts/check_playbook.py [手册路径]
"""
...
PLAYBOOK = paths.SKILL / "pipeline" / "MODELING-PLAYBOOK.md"
